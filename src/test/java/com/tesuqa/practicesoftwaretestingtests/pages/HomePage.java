...
@DefaultUrl("https://v1.practicesoftwaretesting.com/#/")
public class HomePage extends PageObject {
     ...
     */
    public static Target PRODUCT_LIST = Target
            .the("product list")
     ...
     */
    public static Target PRODUCT1 = Target
            .the("product1")
            .locatedBy("//p[@data-test='product-1']");


    public static Target PRODUCT2 = Target
            .the("product2")
